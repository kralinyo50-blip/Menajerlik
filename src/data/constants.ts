...
export const INITIAL_INVESTMENTS = [
  ...
  },
  {
    ...
    lastChange: 0,
    icon: "💵",
    history: invHistory(96000),
    volatility: 0.021,
    drift: 0.0028,
    dividendYield: 0,
    risk: "Orta" as const,
    sector: "Döviz • Hedging",
    description: "Dolar/TL vadeli kontratları. Kur şoklarına karşı portföyünü korur, borsa düzeltmelerinde genelde yön tutar. Kaldıraç kullanılmadan düşük maliyetli döviz pozisyonu.",
    avgCost: 96000,
    dividendsEarned: 0,
    marketBeta: -0.15
  },
  {
    ...
    lastChange: 0,
    icon: "🛢️",
    history: invHistory(128000),
    volatility: 0.056,
    drift: 0.0038,
    dividendYield: 0.032,
    risk: "Yüksek" as const,
    sector: "Emtia • Enerji",
    description: "Brent petrol üreticilerine endeksli fon. Jeopolitik gerginlikte fırlar, talep şokunda sert düşer. Üç aylık temettü öder, enerji krizlerinin ana yarış atı.",
    avgCost: 128000,
    dividendsEarned: 0,
    marketBeta: 0.55
  },
  {
    ...
    lastChange: 0,
    icon: "🎮",
    history: invHistory(54000),
    volatility: 0.121,
    drift: 0.0082,
    dividendYield: 0,
    risk: "Çok Yüksek" as const,
    sector: "VC • E-Spor & Oyun",
    description: "Genç e-spor kulüpleri ve oyun stüdyolarına melek yatırımı. Haftada %±18 oynar; bir tane FIFA kulübüne yatırırsın, üç tane batık çıkar ama dördüncüsü sana stadyum yaptırır.",
    avgCost: 54000,
    dividendsEarned: 0,
    marketBeta: 0.85
  },
  {
    ...
    lastChange: 0,
    icon: "🎨",
    history: invHistory(210000),
    volatility: 0.018,
    drift: 0.0024,
    dividendYield: 0.008,
    risk: "Orta" as const,
    sector: "Alternatif • Sanat",
    description: "Modern sanat koleksiyonuna dayalı kapalı fon. Piyasa ile neredeyse hiç korele değil; müzayedelerde rekor kırılan tabloların %1 hissesi. Vergi stopajı düşük, likidite de öyle.",
    avgCost: 210000,
    dividendsEarned: 0,
    marketBeta: 0.05
  },
  {
    ...
    lastChange: 0,
    icon: "🏦",
    history: invHistory(158000),
    volatility: 0.012,
    drift: 0.0005,
    dividendYield: 0.105,
    risk: "Düşük" as const,
    sector: "Sabit Getiri • Avrupa",
    description: "Alman ve Hollanda tahvillerinden oluşan euro sepeti. Uyuyan dev: haftalık kupon öder, portföyünün sallanmayan ağırlık merkezi. Enflasyona karşı zayıftır.",
    avgCost: 158000,
    dividendsEarned: 0,
    marketBeta: 0.05
  }
