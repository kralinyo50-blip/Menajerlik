...
/** Aktivite adı → sahne varyantı eşleşmesi (3D sahneler için) */
export const ACTIVITY_SCENE_KEY: Record<string, string> = {
  'gym:run': 'gym:run',
  'gym:lift': 'gym:lift',
  'gym:bike': 'gym:bike',
  'games:fifa': 'home:game',
  'games:shooter': 'home:game',
  'games:managerGame': 'home:game',
  'rest:nap': 'home:rest',
  'rest:film': 'home:rest',
  'rest:family': 'home:rest',
  'goOut:walk': 'city:walk',
  'goOut:fans': 'city:walk',
  'goOut:dinner': 'city:walk',
  'vacation:beach': 'city:beach',
  'vacation:mountain': 'city:beach',
  'press:humble': 'studio:press',
  'press:confident': 'studio:press',
  'press:joke': 'studio:press',
};
...
export const SCENE_TITLES: Record<string, { title: string; subtitle: string }> = {
  ...
  'home:game': { title: 'Ev — Oyun Odası', subtitle: 'Konsolun karşısında stres atıyorsun' },
  'home:rest': { title: 'Ev — Oturma Odası', subtitle: 'Kanepeye uzan, enerji topla' },
  'city:walk': { title: 'Şehir — Park ve Caddeler', subtitle: 'Temiz hava, taraftarlar ve şehir hayatı' },
  'city:beach': { title: 'Tatil — Sahil', subtitle: 'Dalga sesi, deniz ve huzur' },
  'studio:press': { title: 'Basın Toplantısı Stüdyosu', subtitle: 'Mikrofonlar açık, kameralar hazır' },
};
